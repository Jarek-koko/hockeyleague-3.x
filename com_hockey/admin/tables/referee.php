 ...
 * referee Table class
 */
class HockeyTableReferee extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__hockey_referees', 'id', $db);
    }
    ...
    public function check() {
        ...
        if (trim($this->name == '')) {
            $this->setError(JText::_('COM_HOCKEY_ERR_REFEREE_NAME'));
            return false;
        }
    ...
    public function store($updateNulls = false)
    {
        ...
        if ($this->id) {
            ...
            $table = JTable::getInstance('Referee', 'HockeyTable');
