 ...
 * Team Table class
 */
class HockeyTableTeam extends JTable
{
    /**
     * Constructor
     *
    ...
    public function check()
    {
        ...
        if (trim($this->name == '')) {
            $this->setError(JText::_('COM_HOCKEY_ERR_TEAM_NAME'));
            return false;
        }
        if (trim($this->short == '')) {
            $this->setError(JText::_('COM_HOCKEY_ERR_TEAM_SHORT_NAME'));
            return false;
        }
        return parent::check();
    }
    ...
    public function store($updateNulls = false)
    {
        ...
        if ($this->id) {
            ...
            $table = JTable::getInstance('Team', 'HockeyTable');
