...
<form action="<?php echo JRoute::_('index.php?option=com_hockey&view=referees'); ?>" method="post" name="adminForm" id="adminForm">
...
<table class="table table-striped" id="refereeList">
    <thead>
        <tr>
            ...
            <th class='left'>
                <?php echo JHtml::_('grid.sort',  'COM_HOCKEY_REFEREES_NAME', 'a.name', $listDirn, $listOrder); ?>
            </th>
            <th class='left'>
                <?php echo JHtml::_('grid.sort',  'COM_HOCKEY_REFEREES_FIRST_NAME', 'a.first_name', $listDirn, $listOrder); ?>
            </th>
    ...
    <?php foreach ($this->items as $i => $item) :
        ...
        <td class="center">
            <?php echo JHtml::_('jgrid.published', $item->state, $i, 'referees.', $canChange, 'cb'); ?>
        </td>
        <td>
        <?php if ($canEdit) : ?>
            <a href="<?php echo JRoute::_('index.php?option=com_hockey&task=referee.edit&id='.(int) $item->id); ?>">
