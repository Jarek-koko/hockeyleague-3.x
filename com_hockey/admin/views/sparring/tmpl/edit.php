...
Joomla.submitbutton = function(task)
{
    ...
    if (task == 'sparring.cancel') {
        ...
        if (task != 'sparring.cancel' && document.formvalidator.isValid(document.id('sparring-form'))) {
            Joomla.submitform(task, document.getElementById('sparring-form'));
        }
        else {
...
<form action="<?php echo JRoute::_('index.php?option=com_hockey&layout=edit&id=' . (int) $this->item->id); ?>" method="post" 
      name="adminForm" id="sparring-form" class="form-validate">
<div class="row-fluid">
...
<div class="span2">
    ...
    <div class="control-group">
     ...
     <?php echo $this->form->getInput('type_of_match',null , 2); ?>
