...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_hockey&task=sparrings.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_hockey&view=sparrings'); ?>" method="post" name="adminForm" id="adminForm">
...
<table class="table table-striped" id="matchList">
    ...
    <?php foreach ($this->items as $i => $item) :
        ...
        <tr class="row<?php echo $i % 2; ?>">
            ...
            <td class="center hidden-phone"><?php echo JHtml::_('jgrid.published', $item->state, $i, 'sparrings.', $canChange, 'cb'); ?></td>
            <td class="hidden-phone">
                <?php if ($item->checked_out) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'sparrings.', $canCheckin); ?>
				<?php endif; ?>
                <?php echo $item->data; ?>
            </td>
            ...
            <td>
               <?php if ($canEdit) : ?>
                <a  class="btn btn-small btn-info" href='<?php echo JRoute::_('index.php?option=com_hockey&view=report&layout=edit&type=2&id_match=' . $item->id); ?>'>
