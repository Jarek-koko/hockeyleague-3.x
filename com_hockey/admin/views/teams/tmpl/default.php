...
<form action="<?php echo JRoute::_('index.php?option=com_hockey&view=teams'); ?>" method="post" name="adminForm" id="adminForm">
...
<div id="filter-bar" class="btn-toolbar">
    ...
    <?php
    for ($i = 65; $i < 91; $i++) {
        echo '<a class="btn btn-small" href="javascript:searchTeam(\'' . chr($i) . '\')">' . chr($i) . '</a>';
    }
    ?>
    </div>    
    <div class="btn-group pull-right hidden-phone">
...
<thead>
    <tr>
        ...
        <th class='left'>
            <?php echo JHtml::_('grid.sort', 'COM_HOCKEY_TEAMS_NAME', 'a.name', $listDirn, $listOrder); ?>
        </th>
...
<?php foreach ($this->items as $i => $item) :
    ...
    <tr class="row<?php echo $i % 2; ?>">
        ...
        <td class="center"><?php echo JHtml::_('jgrid.published', $item->state, $i, 'teams.', $canChange, 'cb'); ?></td>
        <td><?php if ($canEdit) : ?>
                <a href="<?php echo JRoute::_('index.php?option=com_hockey&task=team.edit&id=' . (int) $item->id); ?>">
