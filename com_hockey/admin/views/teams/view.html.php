...
class HockeyViewTeams extends JViewLegacy
{
	...
	protected function addToolbar()
	{
        ...
        JToolBarHelper::title(JText::_('COM_HOCKEY_TITLE_TEAMS') , 'logo.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_hockey&view=teams');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_HOCKEY_TEAMS_NAME'),
