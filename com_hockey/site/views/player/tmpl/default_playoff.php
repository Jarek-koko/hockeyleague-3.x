...
<?php if ($this->player->position != 1): ?>
    <?php if ($this->playoff_stat) : ?>
        <table class="tabplayer" >
            <caption><?php echo JText::_('COM_HOCKEY_PLAYER_PO') ?></caption>
            ...
            <?php endforeach; ?>
        </table><div class="leg_p"><?php echo JText::_('COM_HOCKEY_STATS_INFO_P') ?></div>
    <?php endif; ?>
<?php endif ?>
<?php if ($this->player->position == 1): ?>
    <?php if ($this->playoff_stat): ?>
        <table class="tabplayer">
            ...
            <?php endforeach; ?>
        </table><div class="leg_p"><?php echo JText::_('COM_HOCKEY_STATS_INFO_G') ?></div>
    <?php endif; ?>
<?php endif ?>