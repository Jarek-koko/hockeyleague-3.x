...
if ($month_tmp != $row->mm) : ?>
<div class="headtab">
    <div><?php $text = JString::strtoupper(date('F', mktime(0, 0, 0, $row->mm + 1, 0, 0))); echo JTEXT::_($text); ?></div>
</div>
<table>
    <thead>
        <tr><th><?php echo JText::_('COM_HOCKEY_DATE'); ?></th>
