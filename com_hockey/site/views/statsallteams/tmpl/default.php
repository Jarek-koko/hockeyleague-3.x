...
<ul id="MainTabs" class="nav nav-tabs">
    <li><a data-target="#rs" data-toggle="tab" 
           href="<?php echo JURI::base(true); ?>/index.php?option=com_hockey&view=statsallteams&id=1&<?php echo JSession::getFormToken(); ?>=1&limit=<?php echo $this->limit ?>&format=raw">
            <span><?php echo JText::_('COM_HOCKEY_STAT_PLAYERS_R'); ?> </span>
        </a>
    </li>
    <li><a data-target="#po" data-toggle="tab"
           href="<?php echo JURI::base(true); ?>/index.php?option=com_hockey&view=statsallteams&id=2&<?php echo JSession::getFormToken(); ?>=1&limit=<?php echo $this->limit ?>&format=raw">
            <span><?php echo JText::_('COM_HOCKEY_STAT_PLAYERS_P'); ?> </span>
        </a>
    </li>
    <li><a data-target="#grs" data-toggle="tab" 
           href="<?php echo JURI::base(true); ?>/index.php?option=com_hockey&view=statsallteams&id=3&<?php echo JSession::getFormToken(); ?>=1&limit=<?php echo $this->limit ?>&format=raw">
            <span><?php echo JText::_('COM_HOCKEY_STAT_GOALIES_R'); ?> </span>
        </a>
    </li>
    <li><a data-target="#gpo" data-toggle="tab" 
           href="<?php echo JURI::base(true); ?>/index.php?option=com_hockey&view=statsallteams&id=4&<?php echo JSession::getFormToken(); ?>=1&limit=<?php echo $this->limit ?>&format=raw">
