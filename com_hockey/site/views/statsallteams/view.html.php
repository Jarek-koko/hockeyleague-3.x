...
class HockeyViewStatsallteams extends JViewLegacy {
    ...
    public function display($tpl = null)
    {
        ...
        $this->limit = (int) $this->params->get('limit', 0 );
        $this->show_select = (int) $this->params->get('show_select', 1 );
        $this->title_head = $this->params->get('title_head',  JText::_('COM_HOCKEY_STATSALLTEAMS_TITLE_HEAD'));
    ...
    protected function _prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', JText::_('COM_HOCKEY_STATSALLTEAMS_TITLE_HEAD'));
        }
