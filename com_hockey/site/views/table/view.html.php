...
class HockeyViewTable extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->title_head = $this->params->get('title_head',  JText::_('COM_HOCKEY_STANDINGS_TITLE_HEAD'));
    ...
    protected function _prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', JText::_('COM_HOCKEY_STANDINGS_TITLE_HEAD'));
        }
